...
public extension CGSize {
    ...
    /// iPhone SE 的物理像素尺寸 (750x1334 像素)
    static let iPhoneSE = CGSize(width: 750, height: 1334)

    /// iPhone 4.7英寸的物理像素尺寸 (750x1334 像素)，适用于iPhone 6/7/8等
    static let iPhone47 = CGSize(width: 750, height: 1334)

    /// iPhone 5.4英寸mini的物理像素尺寸 (1080x2340 像素)，适用于iPhone 12/13/14 mini等
    static let iPhoneMini = CGSize(width: 1080, height: 2340)

    // MARK: - iPhone - Standard

    /// iPhone 5.8英寸的物理像素尺寸 (1125x2436 像素)，适用于iPhone X/XS/11 Pro等
    static let iPhone58 = CGSize(width: 1125, height: 2436)

    /// iPhone 6.1英寸LCD的物理像素尺寸 (828x1792 像素)，适用于iPhone XR/11等
    static let iPhone61LCD = CGSize(width: 828, height: 1792)

    /// 标准iPhone的物理像素尺寸 (1170x2532 像素)，适用于iPhone 12/13/14等
    static let iPhone = CGSize(width: 1170, height: 2532)

    /// iPhone 6.1英寸OLED的物理像素尺寸 (1179x2556 像素)，适用于iPhone 12/13/14 Pro等
    static let iPhonePro = CGSize(width: 1179, height: 2556)

    // MARK: - iPhone - Large

    /// iPhone 5.5英寸 Plus的物理像素尺寸 (1242x2208 像素)，适用于iPhone 6/7/8 Plus等
    static let iPhone55 = CGSize(width: 1242, height: 2208)

    /// 6.5英寸iPhone的物理像素尺寸 (1242x2688 像素)，适用于iPhone XS Max、11 Pro Max等
    static let iPhone65 = CGSize(width: 1242, height: 2688)

    /// 大尺寸iPhone Plus的物理像素尺寸 (1284x2778 像素)，适用于iPhone Plus系列
    static let iPhonePlus = CGSize(width: 1284, height: 2778)

    /// 6.9英寸iPhone的物理像素尺寸 (1290x2796 像素)，适用于iPhone 14 Pro Max、15 Pro Max等
    static let iPhone69 = CGSize(width: 1290, height: 2796)

    /// 最大尺寸iPhone的物理像素尺寸 (1290x2796 像素)，适用于iPhone Pro Max系列
    static let iPhoneMax = CGSize(width: 1290, height: 2796)

    // MARK: - iPad

    /// iPad Mini的物理像素尺寸 (1488x2266 像素)
    static let iPadMini = CGSize(width: 1488, height: 2266)

    /// 标准iPad的物理像素尺寸 (1640x2360 像素)
    static let iPad = CGSize(width: 1640, height: 2360)

    /// iPad Pro 11英寸的物理像素尺寸 (1668x2388 像素)
    static let iPadPro11 = CGSize(width: 1668, height: 2388)

    /// iPad Pro 12.9英寸的物理像素尺寸 (2048x2732 像素)
    ...
    /// iMac 24英寸M1/M3/M4屏幕物理像素尺寸 (4480x2520 像素)    
    static let iMac24 = CGSize(width: 4480, height: 2520)

    /// iMac 27英寸Retina屏幕物理像素尺寸 (5120x2880 像素)
    ...
    /// Apple Studio Display 27英寸屏幕物理像素尺寸 (5120x2880 像素)
    static let studioDisplay = CGSize(width: 5120, height: 2880)

    /// Apple Pro Display XDR 32英寸屏幕物理像素尺寸 (6016x3384 像素)
